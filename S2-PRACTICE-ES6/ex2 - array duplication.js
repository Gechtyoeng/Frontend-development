...
const STUDENTS_DATA = [
  { firstName: "An",lastName: "cha",batch: 10, age: 20 },
  { firstName: "Bình",lastName: "choi",batch: 10, age: 22 },
  { firstName: "Cẩm",lastName: "kao",batch: 11, age: 21 },
  { firstName: "An",lastName: "yer",batch: 11, age: 19 }, // Duplicate first name !
];
